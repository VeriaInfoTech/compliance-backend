...
return [
    'service_manager' => [
        ...
        'factories' => [
            ...
            Service\ReportDataMapper::class              => Factory\Service\ReportDataMapperFactory::class,
            Service\EnvironmentalSectionBuilder::class   => Factory\Service\EnvironmentalSectionBuilderFactory::class,
            Service\SocialSectionBuilder::class          => Factory\Service\SocialSectionBuilderFactory::class,
            Service\GovernanceSectionBuilder::class      => Factory\Service\GovernanceSectionBuilderFactory::class,
            Service\ReportGeneratorService::class        => Factory\Service\ReportGeneratorServiceFactory::class,
