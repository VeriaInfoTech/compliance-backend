...
namespace Erm\Factory\Handler\Admin;

use Erm\Handler\Admin\InstallerHandler;
...
use Pi\User\Service\InstallerService;
...
class InstallerHandlerFactory implements FactoryInterface
{
     ...
     *
     * @return \Erm\Handler\Admin\InstallerHandler
