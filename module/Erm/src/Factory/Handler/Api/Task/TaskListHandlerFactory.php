...
class TaskListHandlerFactory implements FactoryInterface
{
    /**
     ...
     */
    public function __invoke(ContainerInterface $container, $requestedName, ?array $options = null):TaskListHandler
    {
