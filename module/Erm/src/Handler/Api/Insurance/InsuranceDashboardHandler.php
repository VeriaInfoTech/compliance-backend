...
class InsuranceDashboardHandler implements RequestHandlerInterface
{
...
//        $params['user_id'] = $account['id'];
        ...
        $domainTree = $this->taskService->getDomainTree(['type' => 'insurance'], []);
        ...
        $tableHeader = [
            ...
            [
                "title" => "تاحدودی رعایت می شود"
            ],
            [
                "title" => "کاملا رعایت می شود"
            ],
        ];
