...
class RiskPerformanceReportHandler implements RequestHandlerInterface
{
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        foreach ($this->taskService->getRiskList($params, $account)['data']['list'] as $task) {
            $allTaskCount++;
            if (!empty($task['risk'])&& ($task['risk']!=new stdClass())) {
                switch ($task['risk']['level']) {
                    case "todo":
        ...
        $taskList = $this->taskService->getRiskList($params, $account)['data']['list'];
