...
use Risk\Handler\Api\Adjustment\AcceptHandler;
use Risk\Service\AdjustmentService;
use Risk\Service\FormService;

class AcceptHandlerFactory implements FactoryInterface
{
    /**
     ...
     */
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null): AcceptHandler
    {
